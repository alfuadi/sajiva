...
def plot_data(selvar, startdate, enddate):
    ...
    dave[['PRES','HGHT','TEMP','DWPT','FRPT','RELH','RELI','MIXR','DRCT','SKNT','THTA','THTE','THTV']] = pd.to_numeric(dave[['PRES','HGHT','TEMP','DWPT','FRPT','RELH','RELI','MIXR','DRCT','SKNT','THTA','THTE','THTV']], errors='coerce')
